...
class UserListTasksResponseEntity {
    public user_id: string
    public firstName:string
    public lastName:string
    public email:string
    ...
    constructor (user_id:string, firstName:string, lastName:string, email:string, passowrd:string, age:number, createdAt:Date, updatedAt:Date,isActive:number,isDeleted:number,tasks:Array<TaskEntity>){
        this.user_id = user_id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
